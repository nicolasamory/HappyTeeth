...
struct SixthStepView: View {
    ...
    let audioPlayer = AVPlayer(url: Bundle.main.url(forResource: "Sixth Step", withExtension: "mp3")!)
...
struct SixthStepView_Previews: PreviewProvider {
    
    static var previews: some View {
        SixthStepView(activePage: .constant(.sixthStep))
    }
}

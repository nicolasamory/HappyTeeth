...
struct FourthStepView: View {
    ...
    let audioPlayer = AVPlayer(url: Bundle.main.url(forResource: "Fourth Step", withExtension: "mp3")!)
...
struct FourthstepView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        FourthStepView(activePage: .constant(.fourthStep))
    }
}

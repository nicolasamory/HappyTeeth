...
struct SecondStepView: View {
    ...
    let audioPlayer = AVPlayer(url: Bundle.main.url(forResource: "Second Step", withExtension: "mp3")!)
...
struct SecondStepView_Previews: PreviewProvider {
    static var previews: some View {
        SecondStepView(activePage: .constant(.secondStep))
    }
}
